...
namespace PAGE.Vue.Ecran
{
    ...
    /// </summary>
    public partial class InformationsSupplementairesBis : Window, IObservateur
    {
        ...
        public InformationsSupplementairesBis(Etudiant EtudiantActuel, Etudiants etudiants)
        {
            InitializeComponent();
